...
const ww = {
    ...
    uitvoeren() {
        ...
        this.bestelling.forEach( boek => {
            ...
            html += `<td>${titel}</td>`
            html += `<td class="bestelformulier__aantal"><i class="fas fa-arrow-down bestelformulier__verlaag" data-role="${boek.ean}"></i>`
            html += `${boek.bestelAantal}`
            html += `<i class="fas fa-arrow-up bestelformulier__verhoog" data-role="${boek.ean}"></i></td>`
